...
#[derive(Debug)]
pub struct TrueFriendProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TrueFriendProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TrueFriend processing");
    
    let mut processor = TrueFriendProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TrueFriendProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TrueFriendProcessor::new(false);
